function initSectionContents(){$("#container").find("section.content").each(function(){"about"==$(this).attr("id")&&iscAbout(),"story"==$(this).attr("id")&&iscStory(),"portfolio"==$(this).attr("id")&&iscPortfolio(),"contact_us"==$(this).attr("id")&&iscContactUs()})}function iscAbout(){var e,o,s,i,t,n=$("section#about"),a=!1,l=n.find("h1"),c=n.find(".about_photo"),d=n.find(".about_cont"),r=n.find(".about_cont.intro").find(".intro_inner>p"),f=new Array,w=new Array,p=n.find(".about_cont.profile").find(">ul").find(">li"),h=n.find(".about_cont.skill").find(">ul").find(">li");r.each(function(o){r.eq(o).css({"transition-delay":.1*(o+1)+"s"})}),p.each(function(o){p.eq(o).css({"transition-delay":.1*(o+1)+"s"})}),h.each(function(o){h.eq(o).css({"transition-delay":.1*(o+1)+"s"}),h.eq(o).find(".gauge .bar").css({"transition-delay":.1*(o+1)+.1+"s"})}),$(window).on("load resize orientationchange",function(){e=n.offset().top,o=n.outerHeight(),s=l.offset().top,i=c.offset().top,d.each(function(o){t=$(window).height()/2,"pc"==deviceMode?f[o]=e+t*o:"mo"==deviceMode&&(f[o]=d.eq(o).offset().top-1.5*t),w[o]=!1}),$(window).scroll()}),$(window).on("scroll",function(){$(window).scrollTop()>=e&&$(window).scrollTop()<=e+o-$(window).height()&&0==a?("pc"==deviceMode?(l.css({position:"fixed",top:""}),d.css({position:"fixed",top:"",bottom:""}),c.css({position:"fixed",top:""})):"mo"==deviceMode&&(l.removeAttr("style"),d.removeAttr("style"),c.removeAttr("style")),a=!0):$(window).scrollTop()<e?("pc"==deviceMode?(l.css({position:"",top:""}),d.css({position:"",top:"",bottom:""}),c.css({position:"",top:""})):"mo"==deviceMode&&(l.removeAttr("style"),d.removeAttr("style"),c.removeAttr("style")),a=!1):$(window).scrollTop()>e+o-$(window).height()&&1==a&&("pc"==deviceMode?(l.css({position:"absolute",top:$(window).scrollTop()-e+(s-e)+"px"}),d.css({position:"absolute",top:$(window).scrollTop()-e+"px"}),c.css({position:"absolute",top:$(window).scrollTop()-e+(i-e)+"px"})):"mo"==deviceMode&&(l.removeAttr("style"),d.removeAttr("style"),c.removeAttr("style")),a=!1),d.each(function(o){$(window).scrollTop()>=f[o]&&$(window).scrollTop()<=f[o]+t&&0==w[o]?(d.removeClass("on"),d.eq(o).addClass("on"),w[o]=!0):($(window).scrollTop()<f[o]&&1==w[o]||$(window).scrollTop()>f[o]+t&&1==w[o])&&(w[o]=!1)})})}function iscStory(){var o,e,s,i=$("section#story"),t=i.find(">.story_cont"),n=new Array,a=new Array,l=new Array;$("#footer");$(window).on("load resize orientationchange",function(){o=i.offset().top,i.outerHeight(),e=!1,t.each(function(e){n[e]=o+$(window).height()/2*(e+1),a[e]=$(window).height()/2,l[e]=!1,t.removeAttr("style"),t.eq(e).find(".sc_inner p").each(function(o){t.eq(e).find(".sc_inner p").eq(o).css({"transition-delay":.15*(o+1)+"s"})})}),s=$("#footer").offset().top,$(window).scroll()}),$(window).on("scroll",function(){$(window).scrollTop()>o&&$(window).scrollTop()<=s-$(window).height()&&0==e?(i.removeClass("end"),i.addClass("fixed"),e=!0):$(window).scrollTop()<=o&&1==e?(t.removeClass("on"),i.removeClass("fixed"),e=!1):$(window).scrollTop()>s-$(window).height()&&1==e&&(i.removeClass("fixed"),i.addClass("end"),e=!1),t.each(function(o){$(window).scrollTop()>n[o]&&$(window).scrollTop()<=n[o]+a[o]&&0==l[o]?(t.eq(o).addClass("on"),l[o]=!0):$(window).scrollTop()<=n[o]&&1==l[o]?(t.eq(o).removeClass("on"),l[o]=!1):$(window).scrollTop()>n[o]+a[o]&&1==l[o]&&(l[o]=!1)})})}function iscPortfolio(){var o,e,s,i=$("section#portfolio"),t=i.find(".pf_cont_inner"),n=(t.find(">h1"),t.find(">h2")),a=t.find(".summary"),l=a.find(">ul>li"),c=a.find(".gauge"),d=c.find(".bar"),r=t.find("ul.detail").find(">li"),f=i.find(".pf_init").find(".block"),w=new Array,p=new Array;$(window).on("load resize orientationchange",function(){o=i.offset().top,e=i.outerHeight(),"pc"==deviceMode?(l.each(function(o){w[o]=f.eq(o).offset().top,p[o]=f.eq(o).height()}),s=parseInt(l.last().css("margin-top")),c.css({height:l.last().offset().top-l.first().offset().top+"px"}),$(window).scrollTop(),$(window).scrollTop()):"mo"==deviceMode&&(r.each(function(o){w[o]=r.eq(o).offset().top,p[o]=r.eq(o).height()}),l.removeClass("active"),d.removeAttr("style"),a.removeAttr("style")),$(window).scroll()}),$(window).on("scroll",function(){pfScrollEnd=function(){return"pc"==deviceMode?e-$(window).height():"mo"==deviceMode?e-r.last().outerHeight():void 0},$(window).scrollTop(),$(window).scrollTop()>=o&&$(window).scrollTop()<=o+pfScrollEnd()&&0==t.hasClass("fixed")?(t.addClass("fixed"),"pc"==deviceMode&&t.css({top:""})):$(window).scrollTop()<o&&1==t.hasClass("fixed")?(t.removeClass("fixed"),l.removeClass("active"),l.eq(0).addClass("active"),r.removeClass("active"),r.eq(0).addClass("active"),"pc"==deviceMode&&(d.css({height:"0px"}),a.css({"margin-top":"0px"}))):$(window).scrollTop()>o+pfScrollEnd()&&1==t.hasClass("fixed")&&(t.removeClass("fixed"),"pc"==deviceMode&&t.css({top:pfScrollEnd()+"px"}),l.removeClass("active"),l.eq(r.last().index()).addClass("active"),r.removeClass("active"),r.eq(r.last().index()).addClass("active"),"pc"==deviceMode)&&(d.css({height:"100%"}),a.css({"margin-top":"-"+(a.height()-l.last().height())+"px"})),l.each(function(o){0<o&&($(window).scrollTop()>=w[o]&&0==l.eq(o).hasClass("on")?l.eq(o).addClass("on"):$(window).scrollTop()<w[o]&&1==l.eq(o).hasClass("on")&&l.eq(o).removeClass("on")),$(window).scrollTop()>=w[o]&&$(window).scrollTop()<=w[o]+p[o]&&0==l.eq(o).hasClass("active")&&(l.removeClass("active"),l.eq(o).addClass("active"),n.text(l.eq(o).attr("data-year")),r.removeClass("active"),r.eq(o).addClass("active"),"pc"==deviceMode)&&(d.css({height:l.eq(o).height()*l.eq(o).index()+s*o+"px"}),a.css({"margin-top":"-"+(l.eq(o).height()*l.eq(o).index()+s*o)+"px"}))})})}function iscContactUs(){var o=$("#contact_us"),e=o.find(".sendmail_form"),s={username:e.find("#sf_username"),email:e.find("#sf_email"),subject:e.find("#sf_subject"),message:e.find("#sf_message")},i=o.find(".sendmail_result"),t=i.find(".sr_message"),n=i.find(".sr_message.ok"),a=i.find(".sr_message.error"),o=t.find(".btn_set button");e.on("submit",function(o){o.preventDefault();o={username:s.username.val(),email:s.email.val(),subject:s.subject.val(),message:s.message.val()};emailjs.send("service_sdvzwe8","template_38okytt",o).then(function(o){t.hide(),n.show(),i.addClass("on"),console.log("SUCCESS!",o.status,o.text)},function(o){t.hide(),a.show(),i.addClass("on"),console.log("FAILED...",o)})}),o.on("click",function(){$(this).hasClass("ok")?(s.username.val(""),s.email.val(""),s.subject.val(""),s.message.val(""),i.removeClass("on")):$(this).hasClass("error")&&i.removeClass("on")})}
...
var deviceMode;function orgVH(){var o;$(window).on("load resize orientationchange",function(){o=.01*window.innerHeight,document.documentElement.style.setProperty("--vh",o+"px")})}function initHeader(){var o,n=$("header#header"),i=n.find("h1");$(window).on("load resize orientationchange",function(){o=n.outerHeight(),1370<$(window).width()?deviceMode="pc":$(window).width()<=1370&&(deviceMode="mo"),$(window).scroll()}),$(window).on("scroll",function(){0<$(window).scrollTop()&&$(window).scrollTop()<o/1.5?(scaleDist=1+$(window).scrollTop()/1.5,bgColorDist=1-$(window).scrollTop()/o*2,i.css({position:"",top:"",bottom:"",transform:"scale("+scaleDist+")",backgroundColor:"rgba(0,0,0,"+bgColorDist+")",opacity:1})):0==$(window).scrollTop()?i.css({transform:"scale(1)",backgroundColor:"rgba(0,0,0,1)"}):$(window).scrollTop()>=o/1.5&&i.css({position:"absolute",top:"auto",bottom:"0px",backgroundColor:"rgba(0,0,0,0)",opacity:0})})}function initGNB(){var o=$("nav#gnb"),n=o.find(">ul"),i=n.find(">li"),e=$("main#container").find("section.content"),t=new Array,a=new Array,r=new Array,s=0,d=0;$(window).on("load resize orientationchange",function(){e.each(function(o){i.eq(o).css({"transition-delay":.1*o+"s"}),t[o]=e.eq(o).offset().top,a[o]=e.eq(o).outerHeight(),r[o]=!1}),$(window).scroll()}),$(window).on("scroll",function(){$(window).scrollTop()>$(window).height()/2-o.height()&&0==n.hasClass("on")?n.addClass("on"):$(window).scrollTop()<=$(window).height()/2-o.height()&&1==n.hasClass("on")&&n.removeClass("on"),e.each(function(o){$(window).scrollTop()>t[o]-$(window).height()/2&&$(window).scrollTop()<=t[o]+a[o]-$(window).height()/2&&0==r[o]?(i.find("a").removeClass("active"),i.eq(o).find("a").addClass("active"),r[d=s=o]):($(window).scrollTop()<=t[o]-$(window).height()/2&&1==r[o]||$(window).scrollTop()>t[o]+a[o]-$(window).height()/2&&1==r[o])&&(i.eq(o).find("a").removeClass("active"),r[d=s=o])})}),i.find(">a").on("click",function(){return d=$(this).parent().index(),$("html,body").animate({scrollTop:Math.round(t[d])},300*Math.abs(d-s),function(){s=d}),!1})}
//# sourceMappingURL=data:application/json;charset=utf-8;base64,